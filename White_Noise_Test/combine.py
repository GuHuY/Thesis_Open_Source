...
RR_data_address = '/Users/rex/python/Thesis_Open_Source/White_Noise_Test/raw_noise/'
...
fully_combined_data_arr = np.array(fully_combined_data)
print(fully_combined_data_arr.shape)
np.savetxt(Output_address +'combine.txt', 
           fully_combined_data_arr,
           fmt='%.4f')