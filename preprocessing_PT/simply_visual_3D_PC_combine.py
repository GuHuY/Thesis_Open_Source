...
for idx in range(len(QRS)):
    ...
    try:
        ...
        for n_left in range(0, interval_num):
    ...
    ratio_1 = current_item[0]/current_item[1]
    ratio_2 = current_item[1]/current_item[2]
    ratio_3 = (current_item[0]+current_item[1])/(current_item[1]+current_item[2])
    ...
    interval_features_list.append([ratio_1, ratio_2, ratio_3])
