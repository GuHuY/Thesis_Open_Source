...
RR_data_address = '/Users/rex/python/z_thesis/RR_trace_wavedet/'
Output_address = '/Users/rex/python/z_thesis/RR_trace_wavedet/'
...
np.savetxt(Output_address +'trace_wavedet_combine.txt', 
